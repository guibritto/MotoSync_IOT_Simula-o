...
--CREATES
--TABELA LEITURA UWB
CREATE TABLE tabela_leitura_uwb (
  id_leitura     NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  tag_id         VARCHAR2(50),
  payload_json   CLOB,           -- guarda o JSON bruto (anchors + distances)
  processed      CHAR(1) DEFAULT 'N', -- 'N' = não processado, 'P' = processado, 'E' = erro
  dt_recebimento DATE DEFAULT SYSDATE
);

CREATE INDEX idx_tabela_leitura_uwb_processed ON tabela_leitura_uwb(processed);
...
INSERT INTO tabela_vaga (id_vaga, codigo, x_coord, y_coord, altura, largura) VALUES (13, 'B02', 2.5, 4.4, 2, 1.1);
INSERT INTO tabela_vaga (id_vaga, codigo, x_coord, y_coord, altura, largura) VALUES (14, 'B03', 3.6, 4.4, 2, 1.1);
INSERT INTO tabela_vaga (id_vaga, codigo, x_coord, y_coord, altura, largura) VALUES (15, 'B04', 4.7, 4.4, 2, 1.1);
INSERT INTO tabela_vaga (id_vaga, codigo, x_coord, y_coord, altura, largura) VALUES (16, 'B05', 5.8, 4.4, 2, 1.1);
INSERT INTO tabela_vaga (id_vaga, codigo, x_coord, y_coord, altura, largura) VALUES (17, 'B06', 6.9, 4.4, 2, 1.1);
INSERT INTO tabela_vaga (id_vaga, codigo, x_coord, y_coord, altura, largura) VALUES (18, 'B07', 8.0, 4.4, 2, 1.1);
INSERT INTO tabela_vaga (id_vaga, codigo, x_coord, y_coord, altura, largura) VALUES (19, 'B08', 9.1, 4.4, 2, 1.1);
INSERT INTO tabela_vaga (id_vaga, codigo, x_coord, y_coord, altura, largura) VALUES (20, 'B09', 10.2, 4.4, 2, 1.1);
INSERT INTO tabela_vaga (id_vaga, codigo, x_coord, y_coord, altura, largura) VALUES (21, 'B10', 11.3, 4.4, 2, 1.1);
INSERT INTO tabela_vaga (id_vaga, codigo, x_coord, y_coord, altura, largura) VALUES (22, 'B11', 12.4, 4.4, 2, 1.1);
-- Fileira C
...
--SELECTS
SELECT * FROM tabela_leitura_uwb;
